...
//    BSD 2-Clause "Simplified" or "FreeBSD" license
    ...
    static {
        ...
        addCodeFromMainNamePattern("ASL", null, "Apache License (no version)", "http://www.apache.org/licenses",  
            "apache"+anyNumberOf(anyOf(" public", " software")));
        ...
        addCodeFromMainNamePattern("EPL", null, "Eclipse Public License (no version)", "http://www.eclipse.org/legal/epl-v10.html",  
            "eclipse"+anyNumberOf(anyOf(" public", " software")));
        ...
        addCodeFromMainNamePattern("CPL", null, "Common Public License (no version)", "http://opensource.org/licenses/cpl1.0.php",  
            "common public"+anyNumberOf(anyOf(" software")));
        ...
        addCodeFromMainNamePattern("CDDL1", "1.0", "Common Development and Distribution License, version 1.0", "http://opensource.org/licenses/CDDL-1.0",  
            "common development"+anyNumberOf(anyOf("\\+", "\\-", "/", " ", "&", "and"))+"distribution");
        addCodeFromMainNamePattern("CDDL", null, "Common Development and Distribution License (no version)", "http://opensource.org/licenses/CDDL-1.0",  
            "common development"+anyNumberOf(anyOf("\\+", "\\-", "/", " ", "&", "and"))+"distribution");
        ...
        addCodeFromMainNamePattern("GPL2", "2.0", "GNU General Public License, version 2.0", "http://www.gnu.org/licenses/gpl-2.0.html",  
            "gnu"+anyNumberOf(anyOf(" general", " public")));
        addCodeFromMainNamePattern("GPL", null, "GNU General Public License (no version)", "http://www.gnu.org/licenses/gpl.html",  
            "gnu"+anyNumberOf(anyOf(" general", " public")));
        ...
        addCodeFromMainNamePattern("LGPL2", "2.0", "GNU Lesser General Public License, version 2.0", "http://www.gnu.org/licenses/lgpl-2.0.html",  
            orReversed("lesser", " ", "gnu")+anyNumberOf(anyOf(" general", " public")));
        addCodeFromMainNamePattern("LGPL", null, "GNU Lesser General Public License (no version)", "http://www.gnu.org/licenses/lgpl.html",  
            orReversed("lesser", " ", "gnu")+anyNumberOf(anyOf(" general", " public")));
        ...
        addCodeFromMainNamePattern("MPL", null, "Mozilla Public License (no version)", "https://www.mozilla.org/MPL/",  
            "mozilla"+anyNumberOf(anyOf(" public", " software")));
        ...
        String bsdPadding = anyNumberOf(anyOf(SEPARATOR_PATTERN, "like", "style"));
        String bsd3Padding = anyNumberOf(anyOf(bsdPadding, bsd3Words));
        String bsd2Padding = anyNumberOf(anyOf(bsdPadding, bsd2Words));
        addCodeWithRegex("BSD-3-Clause", newLicense("The BSD 3-Clause License", "http://opensource.org/licenses/BSD-3-Clause", null),
        ...
        addCodeWithRegex("BSD", newLicense("BSD License (no version)", "http://opensource.org/licenses/BSD-2-Clause", null),
